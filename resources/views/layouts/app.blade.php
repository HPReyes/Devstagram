...
<head>
    ...
    <title>Dekkargram -@yield('titulo')</title>
...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                ...
                <nav class="flex gap-2 items-center">
                    ...
                    class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase cursor-pointer">
            ...
            @guest
                <nav class="flex gap-2 items-center">
                    ...
                    <a href="{{ route('register') }}" class="font-bold uppercase text-gray-600 text-sm">Crear cuenta
    ...
    <footer class="mt-10 text-center p-5 uppercase text-gray-500 font-bold">
        Dekkargram - Todos los derechos reservados {{ now()->year }}
    </footer>
    @livewireScripts
</body>
